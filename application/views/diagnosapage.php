...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="text-center my-primary-color"><i class="fas fa-stethoscope fa-1x"></i> Diagnosa</h1>
    </div>
</div>
                ...
                <div class="card">
                    ...
                    <form method="post" action="<?= base_url('diagnosapage/prosesKonsul') ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <button type="submit" class="btn btn-warning text-white form-control bg-third-color rounded-pill"
