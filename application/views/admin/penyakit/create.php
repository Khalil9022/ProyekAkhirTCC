            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url('admin/penyakit/index') ?>" class="btn btn-warning"><i class="fas fa-undo"></i>
                            Kembali
                        </a>
                    </div>
                    <hr>
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('admin/penyakit/store') ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="penyebab_penyakit" name="penyebab_penyakit" placeholder="Penyebab penyakit" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="solusi_penyakit">Solusi Penyakit</label>
                                            <textarea class="form-control" id="solusi_penyakit" name="solusi_penyakit" placeholder="Solusi penyakit" rows="3"></textarea>
                                        </div>
